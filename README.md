...
- **Tabular / columnar**: Parquet; Arrow IPC / Feather (`.arrow`, `.feather`, `.ipc`); Avro; ORC; NumPy (`.npy`, `.npz`); HDF5 (`.h5`, `.hdf5`); NetCDF (`.nc`, `.cdf`); Matrix Market (`.mtx`)
